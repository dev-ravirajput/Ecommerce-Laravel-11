...
<div class="main-content-inner">
    ...
    <div class="main-content-wrap">
        ...
        <!-- form-add-product -->
        <form action="{{ route('admin.product.store') }}" class="tf-section-2 form-add-product" method="POST"
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="stock_status">
                                <option value="instock" {{ old('sale_price') ? 'selected' : '' }}>In Stock</option>
                                <option value="outofstock" {{ old('sale_price') == 'outofstock' ? 'selected' : '' }}>Out
                                    of Stock</option>
                            </select>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="featured">
                                <option value="0" {{ old('some_field') == '0' ? 'selected' : '' }}>No</option>
                                <option value="1" {{ old('some_field') == '1' ? 'selected' : '' }}>Yes</option>
...
<script>
    $(function(){
        ...
        $('#gFile').on('change', function(e){
            ...
            const gfPhotos = this.files;
            $.each(gfPhotos,function(key,val){
